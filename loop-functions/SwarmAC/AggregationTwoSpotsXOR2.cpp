...
void AggregationTwoSpotsXOR2::PreStep() {
  //std::cout << "Prestep\n";
  // Observe state S
...
void AggregationTwoSpotsXOR2::update_actor(torch::nn::Module& actor_net, torch::Tensor& behavior_probs, 
...
void AggregationTwoSpotsXOR2::print_grid(at::Tensor grid){
