...
#include "AACTestLoopFunc.h"

/****************************************/
/****************************************/

AACTestLoopFunc::AACTestLoopFunc() {
  m_fRadius = 0.3;
...
AACTestLoopFunc::AACTestLoopFunc(const AACTestLoopFunc& orig) {}
...
void AACTestLoopFunc::Destroy() {}

/****************************************/
/****************************************/

void AACTestLoopFunc::Reset() {
  m_fObjectiveFunction = 0;
...
argos::CColor AACTestLoopFunc::GetFloorColor(const argos::CVector2& c_position_on_plane) {
...
Real AACTestLoopFunc::GetObjectiveFunction() {
...
CVector3 AACTestLoopFunc::GetRandomPosition() {
  Real temp;
...
void AACTestLoopFunc::print_grid(at::Tensor grid){
