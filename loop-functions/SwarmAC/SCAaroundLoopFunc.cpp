...
void SCAaroundLoopFunction::PreStep() {
  //std::cout << "Prestep\n";
  // Observe state S
...
double SCAaroundLoopFunction::computeBetaLogPDF(double alpha, double beta, double x) {
...
void SCAaroundLoopFunction::update_actor(torch::nn::Module& actor_net, torch::Tensor& behavior_probs, 
...
void SCAaroundLoopFunction::print_grid(at::Tensor grid){
